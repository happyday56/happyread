...
public class InfomationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  implements IContentItemClick {
...
*/
    ...
    public InfomationAdapter(Context context, List<BaseType.InfoItem> data)
    {
        mContext = context;
        this.data = data;
