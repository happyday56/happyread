...
import com.lgh.happyread.cache.ImageLoaderEx;
...
public class CollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  implements IContentItemClick{
...
/*            case FOOTVIEW_TYPE:
    ...
    public BaseType.InfoItemEx getItem(int position) {
    ...
    public void refreshData(List<BaseType.InfoItemEx> data)
    {
        this.data = data;
        notifyDataSetChanged();
